...
ElementDesc opencv_meta_overlay = {
    ...
    .input_info = MAKE_FRAME_INFO_VECTOR({FrameInfo(ImageFormat::BGRX, MemoryType::VA), FrameInfo(ImageFormat::RGBX, MemoryType::VA),
    ...
    .output_info = MAKE_FRAME_INFO_VECTOR({FrameInfo(ImageFormat::BGRX, MemoryType::VA), FrameInfo(ImageFormat::RGBX, MemoryType::VA),
                    FrameInfo(ImageFormat::BGRX, MemoryType::VAAPI), FrameInfo(ImageFormat::RGBX, MemoryType::VAAPI),
                    FrameInfo(ImageFormat::BGRX, MemoryType::CPU), FrameInfo(ImageFormat::RGBX, MemoryType::CPU)}),
